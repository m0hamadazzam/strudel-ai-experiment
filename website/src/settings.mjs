...
export function useSettings() {
  ...
  return {
    ...
    aiCopilotSidebarWidth: Number(state.aiCopilotSidebarWidth) || 360,
...
export const setAICopilotSidebarWidth = (width) => settingsMap.setKey('aiCopilotSidebarWidth', width);
