...
import { setIsAICopilotSidebarOpened, useSettings } from '@src/settings.mjs';
import { useRef, useState } from 'react';

export default function AICopilotSidebar() {
    const settings = useSettings();
    const { isAICopilotSidebarOpen } = settings;
    ...
    return (
        <nav
            className={cx(
                'bg-lineHighlight group overflow-x-auto h-full border-l border-white/10',
                isAICopilotSidebarOpen ? 'w-[360px]' : 'min-w-12 max-w-12'
            )}
        >
